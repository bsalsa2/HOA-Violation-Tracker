    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        >
          ...
          <div className="min-w-0">
            <h3 className="text-gray-900 font-semibold truncate group-hover:text-gray-900">{hoa.name}</h3>
            <p className="text-xs text-gray-500 truncate mt-0.5">{hoa.address}</p>
          </div>
        </button>
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-gray-600 hover:bg-white/5 hover:text-gray-700 transition-colors"
            title="Settings"
          >
      ...
      <div className="grid grid-cols-3 gap-2 mt-4">
        <div className="bg-white/[0.03] ring-1 ring-white/[0.05] rounded-xl p-2.5">
          <p className="text-lg font-bold text-gray-900 leading-none"><CountUp value={hoa.total_residents} /></p>
    ...
    <div className="min-h-screen bg-transparent text-gray-900">
      <header className="relative bg-white/85 backdrop-blur-xl border-b border-gray-100 px-6 py-3 sticky top-0 z-20">
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <button onClick={onSignOut} className="px-3 py-1.5 text-xs text-gray-600 hover:text-gray-900 border border-gray-200 hover:border-white/20 hover:bg-gray-100 rounded-lg transition-colors">Sign Out</button>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-6 anim-rise">
          <div>
            <h2 className="text-xl font-bold text-gray-900 tracking-tight">Your Clients</h2>
            <p className="text-sm text-gray-500 mt-0.5">{totals.clients} {totals.clients === 1 ? 'community' : 'communities'} under management</p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
          <div className="vt-card p-4 anim-rise stagger-1">
            <p className="text-2xl font-bold text-gray-900"><CountUp value={totals.residents} /></p>
          ...
          <div className="vt-card p-4 anim-rise stagger-3">
            <p className={`text-2xl font-bold ${totals.overdue > 0 ? 'text-red-400' : 'text-gray-600'}`}><CountUp value={totals.overdue} /></p>
          ...
          <div className="vt-card p-4 anim-rise stagger-4">
            ...
            <p className="text-xs text-gray-500 mt-1">Outstanding Fines</p>
          </div>
        </div>
