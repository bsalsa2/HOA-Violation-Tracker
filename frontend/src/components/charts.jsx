        ...
        {centerValue !== undefined && (
          <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
            {active ? (
              ...
              <>
                <span className="text-[26px] font-bold text-slate-100 leading-none tabular tracking-tight">{centerValue}</span>
      ...
      {rows.map((d, i) => (
        <div key={i}>
          <div className="flex justify-between text-xs mb-1.5">
            <span className="text-slate-400 truncate pr-2">{d.label}</span>
