            ...
            results.map((item, i) => (
              ...
              >
                <span className={`w-7 h-7 rounded-lg flex items-center justify-center shrink-0 ring-1 ${
                  item.type === 'action' ? 'bg-[#caa96b]/12 text-[#caa96b] ring-[#caa96b]/25' : item.type === 'resident' ? 'bg-[#8fae8b]/12 text-[#8fae8b] ring-[#8fae8b]/25' : 'bg-[#c17b6a]/12 text-[#c17b6a] ring-[#c17b6a]/25'
                }`}>
                  {item.type === 'action' ? (
