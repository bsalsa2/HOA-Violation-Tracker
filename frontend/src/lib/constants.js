...
export const STATUS_CONFIG = {
  open: { label: 'Open', badge: 'bg-[#10b981]/10 text-[#6ee7b7] border-[#10b981]/25', dot: '#10b981' },
...
export const PRIORITY_CONFIG = {
  ...
  medium: { label: 'Medium', badge: 'bg-[#10b981]/10 text-[#6ee7b7] border-[#10b981]/25', dot: '#10b981' },
...
export const CHART_COLORS = ['#10b981', '#8fae8b', '#c17b6a', '#9aa1ad', '#b89b8e', '#a9b18f', '#6ee7b7', '#8c8f9a', '#bfa6a0', '#7e8a7c']
