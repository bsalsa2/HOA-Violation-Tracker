...
export const STATUS_CONFIG = {
  open: { label: 'Open', badge: 'bg-[#c26c0f]/10 text-[#f59e0b] border-[#c26c0f]/25', dot: '#c26c0f' },
...
export const PRIORITY_CONFIG = {
  ...
  medium: { label: 'Medium', badge: 'bg-[#c26c0f]/10 text-[#f59e0b] border-[#c26c0f]/25', dot: '#c26c0f' },
...
export const CHART_COLORS = ['#c26c0f', '#8fae8b', '#c17b6a', '#9aa1ad', '#b89b8e', '#a9b18f', '#f59e0b', '#8c8f9a', '#bfa6a0', '#7e8a7c']
