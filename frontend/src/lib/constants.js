...
export const STATUS_CONFIG = {
  open: { label: 'Open', badge: 'bg-[#caa96b]/10 text-[#d8be86] border-[#caa96b]/25', dot: '#caa96b' },
...
export const PRIORITY_CONFIG = {
  ...
  medium: { label: 'Medium', badge: 'bg-[#caa96b]/10 text-[#d8be86] border-[#caa96b]/25', dot: '#caa96b' },
...
export const CHART_COLORS = ['#caa96b', '#8fae8b', '#c17b6a', '#9aa1ad', '#b89b8e', '#a9b18f', '#d8be86', '#8c8f9a', '#bfa6a0', '#7e8a7c']
